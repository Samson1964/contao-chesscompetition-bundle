...
(
	...
	(
		...
		'descendant' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_chesscompetition_players']['descendant'],
			'inputType'               => 'checkbox',
			'filter'                  => true,
			'eval'                    => array('submitOnChange'=>true, 'tl_class'=>'clr'),
			'sql'                     => "char(1) NOT NULL default ''"
		...
		'descendant_id' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_chesscompetition_players']['descendant_id'],
			'exclude'                 => true,
			'inputType'               => 'select',
			'options_callback'        => array('tl_chesscompetition_players', 'getPlayer'),
			'eval'                    => array
			(
				'mandatory'           => true,
				'chosen'              => true,
